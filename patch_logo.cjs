...
const svgCode = `
        <defs>
          <linearGradient id="tealLeafGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#2DD4BF" />
            <stop offset="100%" stopColor="#0F766E" />
          </linearGradient>
          <linearGradient id="brightLeafGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#4ADE80" />
            <stop offset="100%" stopColor="#15803D" />
          </linearGradient>
          <linearGradient id="monsteraGrad1" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#059669" />
            <stop offset="100%" stopColor="#064E3B" />
          </linearGradient>
          <linearGradient id="monsteraGrad2" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#10B981" />
            <stop offset="100%" stopColor="#047857" />
          </linearGradient>
          <linearGradient id="pinkFlowerGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#F472B6" />
            <stop offset="100%" stopColor="#DB2777" />
          </linearGradient>
          <linearGradient id="yellowFlowerGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#FDE047" />
            <stop offset="100%" stopColor="#EAB308" />
          </linearGradient>
          <linearGradient id="purpleFlowerGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#818CF8" />
            <stop offset="100%" stopColor="#4F46E5" />
          </linearGradient>
          <linearGradient id="wateringCanGrad" x1="0" y1="0" x2="0" y2="1">
        ...
        {/* 3. SUBTITLE: "By Mannaratharayil Gardens LLP" */}
        {showSubtitle && (
          <g id="subtitle-mannarathayil" className="hidden md:inline">
            ...
            >
              By Mannaratharayil Gardens LLP
            </text>
          </g>
        )}
`;
  ...
  return (
    ...
    >
      <svg
        ...
        aria-label="7 SEASONS by Mannaratharayil Gardens LLP Logo"
      >
${svgCode}
      </svg>
    </div>
...
fs.writeFileSync('src/components/common/Logo.tsx', componentCode);

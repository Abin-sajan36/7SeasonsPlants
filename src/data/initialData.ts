...
export const initialCategories: Category[] = [
  ...
  {
    id: 'cat-air-purifying-combos',
    name: 'Air Purifying Combos',
    slug: 'air-purifying-combos',
    description: 'Scientifically matched NASA clean-air plants for healthy bedrooms and living rooms.',
    image: 'https://images.unsplash.com/photo-1512428813834-c702c7702b78?auto=format&fit=crop&w=800&q=80',
    itemCount: 3,
    isFeatured: true,
    displayOrder: 9,
  ...
  {
    id: 'cat-balcony-combos',
    name: 'Balcony Garden Combos',
    slug: 'balcony-garden-combos',
    description: 'Sun-hardy duos and trios designed for tropical Kerala & South Indian balconies.',
    image: 'https://images.unsplash.com/photo-1508610048659-a06b669e3321?auto=format&fit=crop&w=800&q=80',
    itemCount: 2,
    isFeatured: true,
    displayOrder: 10,
  ...
  {
    id: 'cat-living-balcony',
    name: 'Living Room & Balcony',
    slug: 'living-room-balcony',
    description: 'Pairs that transition seamlessly from bright indoor corners to verandahs.',
    image: 'https://images.unsplash.com/photo-1463936575829-25148e1db1b8?auto=format&fit=crop&w=800&q=80',
    itemCount: 2,
    isFeatured: false,
    displayOrder: 11,
  ...
  {
    id: 'cat-low-maint-combos',
    name: 'Low Maintenance Combos',
    slug: 'low-maintenance-combos',
    description: 'Drought-tolerant, forgiving plant pairings ideal for beginners and busy homes.',
    image: 'https://images.unsplash.com/photo-1509423350716-97f9360b4e09?auto=format&fit=crop&w=800&q=80',
    itemCount: 2,
    isFeatured: true,
    displayOrder: 12,
  ...
  {
    id: 'cat-desk-workspace',
    name: 'Desk & Workspace',
    slug: 'desk-workspace',
    description: 'Compact tabletop plant bundles that purify personal airspace without clutter.',
    image: 'https://images.unsplash.com/photo-1545241047-6083a3684587?auto=format&fit=crop&w=800&q=80',
    itemCount: 2,
    isFeatured: false,
    displayOrder: 13,
  ...
  {
    id: 'cat-flowering-balcony',
    name: 'Flowering Balcony Pairs',
    slug: 'flowering-balcony-pairs',
    description: 'Color-burst flowering pairs acclimated for tropical gardens and sunny sills.',
    image: 'https://images.unsplash.com/photo-1508610048659-a06b669e3321?auto=format&fit=crop&w=800&q=80',
    itemCount: 1,
    isFeatured: false,
    displayOrder: 14,
...
export const initialBanners: HeroBanner[] = [
  {
    ...
    subtitle: 'Thoughtfully curated tropical plant combos and botanical collections, delivered to your doorstep across Kerala & Tamil Nadu.',
    badge: 'FRESH FROM MANNARATHARAYIL GARDENS LLP',
    ctaText: 'Explore Plant Combos',
    ctaLink: '/combos',
  ...
  },
  {
    ...
    subtitle: 'Root-sealed and aerated packaging ensures curated combos arrive fresh, hydrated, and ready to thrive.',
    badge: '100% HEALTHY PLANT PROMISE',
    ctaText: 'Best Selling Combos',
    ctaLink: '/combos',
    secondaryCtaText: 'Plant Doctor AI',
    secondaryCtaLink: '/plant-care',
